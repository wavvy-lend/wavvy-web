      ...
      <Dialog as="div" className="relative z-10" initialFocus={ref} onClose={close}>
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="maxh-[642px] relative h-full w-full max-w-[911px] transform overflow-hidden rounded-3xl bg-grey-200 px-[45px] py-[26px] text-left shadow-xl transition-all">
