      ...
      {!isAuthenticated && !address ? (
        ...
        <>
          <Popover className="relative">
            {({ open }) => (
              <>
                <Popover.Button className="flex items-center justify-center gap-2.5 rounded-lg bg-alt-300 px-[29px] py-[15px] font-rob text-[14px]/[14px] font-bold text-white">
                ...
                >
                  <Popover.Panel className="absolute z-10 mt-3 flex w-[200px] flex-col items-center gap-4 overflow-hidden rounded-lg bg-alt-300 bg-opacity-5 shadow-lg backdrop-blur-[10px]  backdrop-filter  transition-opacity">
                    ...
                    <div className="w-full flex-col gap-4 px-2 py-4 first-letter:flex">
                      <button className="flex w-full items-center justify-center gap-4 rounded-lg bg-alt-200 bg-opacity-20 p-2 text-[14px]/[14px] font-bold text-grey-100 hover:bg-opacity-50">
                        <span>Logout</span>
